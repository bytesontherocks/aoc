...
namespace {
    std::vector<size_t>v = {1,2,1,3,2,1,1,5,1,4,1,2,1,4,3,3,5,1,1,3,5,3,4,5,5,4,3,1,1,4,3,1,5,2,5,2,4,1,1,1,1,1,1,1,4,1,4,4,4,1,4,4,1,4,2,1,1,1,1,3,5,4,3,3,
...
int main (void)
{
    std::cout << "First exercice result 2 days: " << measurements::calculateFirstExercice(v,80) << std::endl;

    std::cout << "Second exercice result: " << measurements::calculateSecondExercice(v, 256) << std::endl;  
